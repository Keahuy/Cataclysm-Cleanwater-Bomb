...
> [!IMPORTANT] **Moved / 已迁移**
>
> Stable document ID / 稳定文档 ID: `json.effects`
> 中文: https://crimsoncrossbunker.github.io/CCB-Docs/reference/json/effects/
> English: https://crimsoncrossbunker.github.io/CCB-Docs/en/reference/json/effects/
